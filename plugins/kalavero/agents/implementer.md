...
4. **Verify**: run the task's verification commands — affected tests at minimum, plus build/lint if the project has them. If the plan names a full-suite check, run it.
