...
3. Install [Pi](https://pi.dev/), [OpenCode](https://opencode.ai/), [no-mistakes](https://github.com/kunchenguid/no-mistakes), and the [Skills CLI](https://skills.sh/), then add shared agent skills ([AXI](https://github.com/kunchenguid/axi), [Lavish](https://github.com/kunchenguid/lavish-axi)) and Lavish's session hooks
