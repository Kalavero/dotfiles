...
3. Install [Pi](https://pi.dev/), [OpenCode](https://opencode.ai/), and the [Skills CLI](https://skills.sh/), then add shared agent skills ([AXI](https://github.com/kunchenguid/axi), [Lavish](https://github.com/kunchenguid/lavish-axi)) and Lavish's session hooks
